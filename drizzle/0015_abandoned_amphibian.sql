...
--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "review_status" text DEFAULT 'normal' NOT NULL;--> statement-breakpoint
...
CREATE INDEX "users_review_status_idx" ON "users" USING btree ("review_status");